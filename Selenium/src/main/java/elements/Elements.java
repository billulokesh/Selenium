...
public class Elements {
 ...
 public static String signup="//button[@data-qa='signup-button']";
 public static String mr="//label[@for='id_gender1']";
 public static String Pswd="//input[@type='password']";
 public static String day="//Select[@id='days']";
 public static String month="//Select[@id='months']";
 public static String year="//Select[@id='years']";
 public static String firstname="//input[@data-qa='first_name']";
 public static String lastname="//input[@data-qa='last_name']";
 public static String company="//input[@data-qa='company']";
 public static String adress="//input[@data-qa='address']";
 public static String state="//input[@data-qa='state']";
 public static String city="//input[@data-qa='city']";
